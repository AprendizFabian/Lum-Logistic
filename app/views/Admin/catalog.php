            ...
            <section class="flex-1 px-6 py-10 max-w-screen-xl mx-auto">
                    ...
                    <?php foreach ($productos as $producto): ?>
                        ...
                        <div
                            ...
                            <div class="p-5 flex flex-col gap-3 flex-grow">
                                ...
                                <span
                                    class="inline-block px-3 py-1 text-xs font-semibold text-[#404141] bg-[#FEDF00] rounded-full w-fit shadow">
                                    <i
                                        class="fa-solid fa-tag mr-1"></i><?= htmlspecialchars($producto['shelf_life_concept']) ?>
                                </span>
                            </div>
                        </div>
                    <?php endforeach; ?>
                ...
                <?php if ($totalPages > 1): ?>
                    <div class="mt-10 flex flex-wrap justify-center gap-2">
                        ...
                        for ($i = $start; $i <= $end; $i++): ?>
                            <a href="?page=<?= $i ?>&search=<?= urlencode($search) ?>" class="px-4 py-2 border rounded-full transition font-semibold
                    <?= $page == $i
